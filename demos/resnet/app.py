...
real_example_list = [
    ...
    ["examples/real/0211.jpg", "Real", "Good"],
    ...
    ["examples/real/2188.jpg", "Real", "Okay, misclassified part of the sky as the house"],
    ...
    ["examples/real/0069.jpg", "Real", "Okay, didn't replace the sky between the houses"],
    ["examples/real/2079.jpg", "Real", "Okay, missing details in the trees"],
    ["examples/real/2038.jpg", "Real", "Bad, lacks overall details in both trees and tree branches"],
    ["examples/real/0001.jpg", "Real", "Bad, missing detail around the lamppost and the tree"],
    ["examples/real/0894.jpg", "Real", "Bad, missing details in the trees"],
    ["examples/real/2026.jpg", "Real", "Bad, lacks tree details in the left background"],
]
...
synthetic_example_list = [
    ...
    ["examples/synthetic/0097.jpg", "Synthetic", "Acceptable, missing minor detail in the trees"],
    ["examples/synthetic/0124.jpg", "Synthetic", "Okay, missing details in the trees"],
    ["examples/synthetic/0127.jpg", "Synthetic", "Okay, missing details in the trees"],
    ["examples/synthetic/10467.jpg", "Synthetic", "Okay, misclassified the windows as sky"],
    ["examples/synthetic/0059.jpg", "Synthetic", "Bad, misclassified the windows as sky"],
]
