...
class Configuration(BaseModel):
    """
    Configuration for the replacement pipeline.
...
def get_configurations() -> Configuration:
    """
    Loads the configuration for the replacement pipeline.

    Returns:
        Configuration: The configuration for the replacement pipeline
    """
