...
def get_train_transforms(resolution: int) -> transforms.Compose:
...
def get_val_transforms(resolution: int) -> transforms.Compose:
    return transforms.Compose([
...
def get_test_transforms(resolution: int) -> transforms.Compose:
    return transforms.Compose([
