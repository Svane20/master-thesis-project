...
def main() -> None:
    ...
    if platform.system() == "Windows":
        configuration_path: Path = root_directory / "unet_vgg16/configs/deployment_windows.yaml"
    else:  # Assume Linux for any non-Windows OS
        configuration_path: Path = root_directory / "unet_vgg16/configs/deployment_linux.yaml"
